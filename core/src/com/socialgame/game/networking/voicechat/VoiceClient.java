...
public class VoiceClient implements Disposable{
     ...
     */
         ...
         */
        public VoiceClient(Kryo kryo, int sampleRate){
            this(kryo);
         ...
         */
        public void sendVoice(VoiceChatClient client, float delta){
